...
const copy = {
  th: {
    ...
    partnerTitle: 'สนใจอุปกรณ์ XTEINK? ซื้อผ่านลิงก์พันธมิตรของ Ekicross',
    ...
    partnerNote: 'ลิงก์พันธมิตรอย่างเป็นทางการ · เชื่อมต่อสู่เว็บไซต์ XTEINK โดยตรง',
  ...
  en: {
    ...
    partnerLabel: 'OFFICIAL STORE PARTNER',
    partnerTitle: 'Considering an XTEINK device? Buy through Ekicross',
    ...
    partnerNote: 'Official partner link · Connects directly to the XTEINK website',
