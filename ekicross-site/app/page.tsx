...
const copy = {
  th: {
    ...
    developmentTitle: 'ทำขึ้น ใช้งานจริง แล้วปรับซ้ำๆ จนกว่าจะลงตัว',
    ...
    partnerTitle: 'เลือกซื้ออุปกรณ์ XTEINK ผ่าน Ekicross',
    partnerBody: 'ลิงก์นี้พาไปยัง XTEINK Official Store โดยตรง เพื่อให้คุณเลือกซื้อรุ่นและอุปกรณ์ที่ตรงกับความต้องการได้อย่างมั่นใจ รวมถึงไม่พลาดโอกาสรับโปรโมชันจากร้านทางการ พร้อมช่วยสนับสนุนให้ Ekicross พัฒนาประสบการณ์ภาษาไทยบนอุปกรณ์นี้ให้ดียิ่งขึ้น',
    partnerAction: 'เลือกซื้อผ่าน XTEINK Official Store',
    partnerNote: 'เลือกซื้ออย่างมั่นใจ พร้อมสนับสนุน Ekicross',
    ...
    changelogNote: 'หมายเหตุ: เวอร์ชันที่ถูกข้ามไปมีการอัปเดตและปรับปรุงเนื้อหาอย่างต่อเนื่อง โดยถูกนำไปใช้ทดสอบภายในและปล่อยให้กลุ่มเบต้าเทสเตอร์ทดลองใช้งานก่อนที่จะเผยแพร่เป็นเวอร์ชันทางการ',
  ...
  en: {
    ...
    eyebrow: 'EKICROSS FOR XTEINK X3',
    title: 'More Than Firmware.\nWhere Reading Meets Imagination.',
    intro: 'Ekicross began with a simple need: make reading in English and Thai feel beautiful and complete on X3, with everything remaining natural to use through the device’s physical buttons.',
    ...
    storyBody1: 'Ekicross grew from the wish to make a personal X3 as good as possible for reading in English and Thai—like homemade food or baking, where every ingredient is chosen and the result is refined until it feels right.',
    ...
    showcaseBody: 'The firmware Home screen on a real device, showing English and Thai typography, menus, recent books, and physical-button operation on X3.',
    ...
    developerTitle: 'Caring for every detail, from language support to reading flow',
    developerBody: 'Ekicross is developed through real daily use on X3, with each detail refined for a natural reading experience in both English and Thai.',
    ...
    partnerLabel: 'OFFICIAL STORE PARTNER',
    partnerTitle: 'Choose your XTEINK device through Ekicross',
    partnerBody: 'This link takes you directly to the XTEINK Official Store, so you can choose the right device and accessories with confidence, stay close to official promotions, and help Ekicross keep improving the Thai reading experience on this device.',
    partnerAction: 'Shop at XTEINK Official Store',
    partnerNote: 'Shop with confidence while supporting Ekicross',
    ...
    changelogNote: 'Note: Versions not shown here were continuously updated and refined, used for internal testing and beta-tester trials before an official release.',
...
const changelogEntries = [
  ...
  },
  {
    version: '4.3.1',
    state: 'previous',
    status: { th: 'รุ่นเผยแพร่ก่อนหน้า', en: 'Previous public release' },
  ...
  return (
    <main lang={lang}>
        ...
        <article className="support-card glass" aria-labelledby="support-title">
          ...
          <div className="support-qr">
            <div className="support-qr-visual">
              <img src={assetPath('/promptpay-qr-20260920.png')} alt={lang === 'th' ? 'QR Code สำหรับสนับสนุนผู้พัฒนาผ่าน PromptPay' : 'PromptPay QR code to support the developer'} />
            </div>
      ...
      <section className="changelog wrap" id="changelog">
        ...
        <div className="changelog-heading"><h2>{t.changelogTitle}</h2><p>{t.changelogNote}</p></div>
