...
const copy = {
  th: {
    ...
    releaseBody: 'Ekicross มีให้เลือกสองรุ่นสำหรับ XTEINK X3 ได้แก่ 4.0.1 Stable สำหรับผู้ที่ต้องการความเสถียร และ 4.1.1 Update ซึ่งเพิ่ม Gallery หน้าสถิติการอ่านแบบใหม่ Dark Mode ที่ดีขึ้น และปรับการจัดข้อความเต็มบรรทัดให้เหมาะกับภาษาไทยมากขึ้น',
    target: 'รองรับเฉพาะ',
  ...
  en: {
    ...
    releaseBody: 'Ekicross is distributed in two XTEINK X3 releases: 4.0.1 Stable for a settled experience and 4.1.1 Update with Gallery, a redesigned reading statistics screen, improved Dark Mode, and better full justification for Thai text.',
